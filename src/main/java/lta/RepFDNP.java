...
public class RepFDNP {
    ...
    public RepFDNP(String filename, String path, double th, int w1, int w2) {
        this.threshold = th;
        this.w1 = w1;
        this.w2 = w2;
        this.filename = filename;
        this.path = path;
        this.similarityFunc = 4;
    }
    ...
    public static void main(String[] args) throws CsvException, IOException {
        ...
        RepFDNP repFD = new RepFDNP(fileName, filePath, 0.85, 5, 2);
