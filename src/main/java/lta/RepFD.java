...
public class RepFD {
    ...
    private List<FDResult> result_g;
    ...
    public double[] execute() throws IOException, CsvException {
        ...
        level0 = new Object2ObjectOpenHashMap<BitSet, SimpleCombinationHelper>();
        level1 = new Object2ObjectOpenHashMap<BitSet, SimpleCombinationHelper>();
        ...
        this.mmCombinedPartitions = new CombinedPartition(this.numberAttributes);
        ...
        // Initialize Level 0
        SimpleCombinationHelper chLevel0 = new SimpleCombinationHelper();
...
//                    }
    ...
    private void generateNextLevel() {
        ...
        Object2ObjectOpenHashMap<BitSet, SimpleCombinationHelper> new_level = new Object2ObjectOpenHashMap<BitSet,
                SimpleCombinationHelper>();
        buildPrefixBlocks();
